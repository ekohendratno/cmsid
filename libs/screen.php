...
function do_meta_boxes( $context, $object ) {
	...
	printf('<div id="%s-sortables" class="meta-box-sortables col-md-6">', htmlspecialchars($context));
		...
		foreach ( array('high', 'sorted', 'core', 'default', 'low') as $priority ) {
			if ( isset($meta_boxes[$context][$priority]) ) {
				foreach ( (array) $meta_boxes[$context][$priority] as $box ) {
					...
					$i++;
					$style = '';
					echo '<div class="panel panel-default dragbox" id="' . $box['id'] . '">'."\n";
					echo '<div class="panel-heading"><strong>' . $box['title'] . "</strong>\n";	
					echo '<div class="pull-right">';						
					
					echo '<a href="#" data-perform="panel-collapse" data-toggle="tooltip" data-placement="left" title="" data-original-title="Resize Panel" class="pull-right tp-resize"><i class="glyphicon glyphicon-resize-small"></i></a>';
					echo '<a href="#" data-perform="panel-move" data-toggle="tooltip" data-placement="left" title="" data-original-title="Moved Panel" class="pull-right to-move"><i class="glyphicon glyphicon-move"></i></a>';
					echo '<a href="#" data-perform="panel-dismiss" data-toggle="tooltip" data-placement="left" title="" data-original-title="Remove Panel" class="pull-right to-remove" style="visibility: hidden;"><i class="glyphicon glyphicon-remove"></i></a>';
					...
					echo '</div>' . "\n";
					echo '</div>' . "\n";
					echo '<div class="panel-body" id="panel_content_' . $box['id'] . '">'."\n";
